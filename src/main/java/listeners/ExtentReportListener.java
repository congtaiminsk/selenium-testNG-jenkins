...
public class ExtentReportListener extends BasePage implements ITestListener, ISuiteListener {
	...
	public void onTestStart(ITestResult result) {
		...
		logger.log(LogStatus.INFO, "Start executing testcase: " + result.getTestClass().getName()+ "_" + result.getMethod().getMethodName());

	}

	@Override
	public void onTestSuccess(ITestResult result) {
		logger.log(LogStatus.INFO, "Amazing Good Job");
	}
	...
	public void onTestFailure(ITestResult result) {
		...
		logger.log(LogStatus.FAIL, "Test failed, attaching screenshot in screenshots folder. Failed reason: " + result.getThrowable());
	}
